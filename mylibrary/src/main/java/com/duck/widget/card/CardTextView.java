...
//    @BindView(R2.id.duck_materialCardView) MaterialCardView materialCardView;
//    @BindView(R2.id.duck_contentLayout) LinearLayout contentLayout;
//    @BindView(R2.id.duck_mTextImageView) TextImageView mTextImageView;
//
